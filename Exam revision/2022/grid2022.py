...
class Grid:
    ...
    def steps(self):
        ...
        self.grid_mew = - self.a * self.grid_phi + self.a * (self.grid_phi) ** 3 - self.X * self.grid_M**2 + self.K / (self.dx ** 2) * neighbours_mew
        ...
        self.grid_M += (self.dt * self.D)/(self.dx**2) * neighbours_M - self.dt * ((self.c - self.X*self.grid_phi)*self.grid_M + self.c * self.grid_M)
